...
async def inference(
    ...
    # Read the audio file
    ###print the file information to identify its fomrat and size
    print(111111122222222222223333333333344444444555555555566666666666666666,file)
    audio_content = await file.read()

    temperature += temperature_inc

    # --- Debugging line ---
    logger.debug(f"Received file: filename='{file.filename}', content_type='{file.content_type}', size={len(audio_content)} bytes")
    # --- End Debugging line ---
